/* ============================================================================
   ...
   <script>...</script> より「後」に以下のように読み込んでください。
     ...
     <script src="dyslexia-support-pack-v0.2.js"></script>
     </body>
...
(function(){
  ...
  whenAppReady(function(){
    ...
    if (brand) brand.insertAdjacentHTML('beforeend', ' <span class="dlc-badge">📖 ディスレクシア支援パック v0.2</span>');
    ...
    dlcLog('ディスレクシア支援パックを有効化', 'v0.2');

    console.log('[読みノート] ディスレクシア支援パック v0.2 を有効化しました。');
  });
})();
