/* ============================================================================
   ...
   <script>...</script> より「後」に以下のように読み込んでください。
     ...
     <script src="dyslexia-support-pack-v0.4.js"></script>
     </body>
...
(function(){
  ...
  whenAppReady(function(){
    ...
    if (brand) brand.insertAdjacentHTML('beforeend', ' <span class="dlc-badge">📖 ディスレクシア支援パック v0.4</span>');
    ...
    dlcLog('ディスレクシア支援パックを有効化', 'v0.4');

    console.log('[読みノート] ディスレクシア支援パック v0.4 を有効化しました。');
  });
})();
