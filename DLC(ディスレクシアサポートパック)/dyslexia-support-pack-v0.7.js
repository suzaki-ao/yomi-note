...
(function(){
  ...
  whenAppReady(function(){
    ...
    if (brand) brand.insertAdjacentHTML('beforeend', ' <span class="dlc-badge">📖 ディスレクシア支援パック v0.7</span>');
    ...
    dlcLog('ディスレクシア支援パックを有効化', 'v0.7');

    console.log('[読みノート] ディスレクシア支援パック v0.7 を有効化しました。');
  });
})();
