/* ============================================================================
   ...
   <script>...</script> より「後」に以下のように読み込んでください。
     ...
     <script src="dyslexia-support-pack-v0.9.js"></script>
     </body>
...
(function(){
  ...
  whenAppReady(function(){
    ...
    if (brand) brand.insertAdjacentHTML('beforeend', ' <span class="dlc-badge">📖 ディスレクシア支援パック v0.9</span>');
    ...
    console.log('[読みノート] ディスレクシア支援パック v0.9 を有効化しました。');
  });
})();
